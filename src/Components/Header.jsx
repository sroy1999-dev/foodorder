...
const Header = () => {
  ...
  {/*This will give authentication detaills of the app*/ }
              ...
              onClick={login} />
            {
              isMenu && (
                <motion.div
                  ...
                  {
                    user && user.email === "roysuvam1999@gmail.com" && (
                      <Link to={'/createItem'}>
            ...
            onClick={login} />
          {
            isMenu && (
              <motion.div
                ...
                <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-slate-200 gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base'
                  onClick={logout}>Logout <MdLogout /></p>
              </motion.div>
            )
          }
