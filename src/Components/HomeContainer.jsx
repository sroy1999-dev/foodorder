  ...
  return (
    <section className='grid grid-co0ls-1 md:grid-cols-2 gap-2 w-full' id='home'>
      ...
      <div className='py-2 flex-1 flex items-center relative'>
        <img src={Hero} className='ml-auto h-420 w-full lg:w-auto lg:h-650' alt="hero" />
        <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-4 gap-4 grid grid-cols-2 flex-wrap'>
